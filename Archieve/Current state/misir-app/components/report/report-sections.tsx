...
import type { SubspaceSummary } from "@/lib/types/reports";
    ...
    return (
        <section className="py-6 sm:py-8">
            <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-6">
                <span className="flex-shrink-0 w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center rounded-full bg-foreground/5 text-foreground text-xs sm:text-sm font-medium">
                    {number}
                </span>
